...
bf_stack_t stack_new()
{
#define DEFAULT_SIZE 64
    long *data = malloc(sizeof(long) * DEFAULT_SIZE);
    bf_stack_t ret = {.cap = DEFAULT_SIZE, .top = 0, .data = data};
    return ret;
}

void push(bf_stack_t *stack, long pos)
{
